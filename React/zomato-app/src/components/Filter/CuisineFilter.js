    ...
    return (
      <>
        ...
        <div onChange={this.filterCuisine}>
          ...
          <label className="radio">
            <input type="radio" name="cuisine" value="1" className="button"/>
            North Indian
          </label><br/>
          <label className="radio">
            <input type="radio" name="cuisine" value="2" className="button"/>
            South Indian
          </label><br/>
          <label className="radio">
            <input type="radio" name="cuisine" value="3" className="button"/>
            Chinese
          </label><br/>
          <label className="radio">
            <input type="radio" name="cuisine" value="4" className="button"/>
            Fast Food
          </label><br/>
          <label className="radio">
            <input type="radio" name="cuisine" value="5" className="button"/>
            Street Food
          </label>
        </div>
      </>
